...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	install: function(Vue, options){
		...
		var options = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.merge(optionsDefaults, options)

		if(!__WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.get(options.name)){

			__WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set(options.name, {})
		...
		Vue.mixin({
			...
			methods: {
				...
				yCart_do_check: function(id){
					...
					return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(this.yCart_data_items, id)

				},

				yCart_do_Update: function(){

					__WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.set(options.name, this.yCart_data_items)
			...
			computed: {
				...
				yCart_see_Total: function(){
					...
					__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.forEach(this.yCart_data_items, function(item){
				...
				yCart_see_Count: function(){
					...
					return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.size(this.yCart_data_items)
			...
			data: ()=>{
				...
				return {
					...
					yCart_data_items: __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a.getJSON(options.name)
